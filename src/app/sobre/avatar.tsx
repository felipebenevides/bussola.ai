...
export function Avatar({ src, initials }: { src: string; initials: string }) {
  ...
  return (
    <div className="relative mx-auto md:mx-0">
      ...
      <div className="relative h-44 w-44 overflow-hidden rounded-3xl border border-zinc-200 bg-zinc-100 shadow-2xl dark:border-zinc-800 dark:bg-zinc-900 sm:h-56 sm:w-56">
        {!errored && (
      ...
      <div className="absolute -bottom-2 left-1/2 flex -translate-x-1/2 items-center gap-1.5 rounded-full border border-emerald-500/60 bg-white px-3 py-1 text-[10px] font-medium text-emerald-700 shadow-md dark:border-emerald-700/60 dark:bg-zinc-950 dark:text-emerald-300 md:left-auto md:right-2 md:translate-x-0">
